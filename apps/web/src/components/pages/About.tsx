...
import { Film, Bot, Search, Database, Zap, Layers, Code2 } from "lucide-react";
    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto transition-colors duration-200">
      ...
      <div className="text-center space-y-4 mb-16">
        ...
        <p className="max-w-2xl mx-auto text-lg text-slate-600 dark:text-slate-400">
          Your unified personal hub for Movies, TV Shows, K-Dramas, Anime,
          Manga, and Manhwa—backed by an AI assistant that actually knows what
          you watch.
        </p>
      </div>
      ...
      <div className="rounded-3xl bg-white text-black dark:bg-slate-900 dark:text-white p-8 sm:p-12 mb-20 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 text-sm">
            ...
            <div className="border-l-2 border-cyan-500 pl-4">
              <span className="text-slate-400 block text-xs">Backend</span>
            ...
            <div className="border-l-2 border-cyan-500 pl-4">
              ...
              <span className="font-semibold text-base">PostgreSQL</span>
            </div>
          </div>
        </div>
      </div>
      <div className="text-center space-y-6">
        <h3 className="text-xl font-bold">Powered by Open Source APIs</h3>
        <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-12 opacity-75">
          <span className="flex items-center gap-2 font-medium text-slate-600 dark:text-slate-400">
            <Database className="w-4 h-4 text-cyan-500" /> OMDB
          </span>
          <span className="flex items-center gap-2 font-medium text-slate-600 dark:text-slate-400">
            <Search className="w-4 h-4 text-cyan-500" /> Anilist
          </span>
          <span className="flex items-center gap-2 font-medium text-slate-600 dark:text-slate-400">
            <Layers className="w-4 h-4 text-cyan-500" /> TVmaze
          </span>
        </div>
      </div>
    </div>
